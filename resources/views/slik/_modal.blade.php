    ...
    <div class="modal-content">
      ...
      <form method="POST" action="{{ route('slik.store') }}" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
              ...
              <div class="mt-3 p-3 bg-light border rounded">
                <label class="form-label fw-bold text-danger">
                    <i class="bi bi-file-earmark-code me-1"></i>Upload File Raw SLIK
                </label>
                <div class="input-group">
                  <input type="file" class="form-control" name="file_slik" accept=".txt,.json" required>
                  <span class="input-group-text text-danger bg-white border-start-0"><i class="bi bi-asterisk"></i></span>
                </div>
                <div class="form-text text-muted mt-2" style="font-size: 0.8rem; line-height: 1.2;">
                    <i class="bi bi-info-circle me-1"></i>Upload file mentahan <strong>.txt</strong> atau <strong>.json</strong> dari OJK. Sistem akan otomatis memprosesnya menjadi Excel.
                </div>
              </div>
              </div>
          </div>
        ...
        <div class="modal-footer d-flex justify-content-end gap-2">
          <button type="submit" class="btn" style="background:#1dd1a1; color:white; font-weight:600;"><i class="bi bi-gear-wide-connected me-1"></i>Proses & Simpan</button>
...
<style>
    /* Container */
    #modalUploadHasil .modal-content {
        border-radius: 18px;
        overflow: hidden;
    }

    #modalUploadHasil .modal-body {
        padding-top: 1.25rem;
    }
    ...
    /* Footer buttons */
    #modalUploadHasil .btn-primary {
        background: #58cbdd;
        border-color: #58cbdd;
    }

    #modalUploadHasil .btn-primary:hover {
        background: #42b7c9;
        border-color: #42b7c9;
    }
</style>
...
<div class="modal fade" id="modalUploadHasil" tabindex="-1" aria-labelledby="modalUploadHasilLabel"
    aria-hidden="true">
                    ...
                    <div class="upload-section" id="uploadSection1">
                        <div class="upload-section-header">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <button type="button" class="btn-select-file" id="btnSelectFile1">Select
                                    files...</button>
                            </div>
                        </div>
                        <input type="file" class="d-none" name="hasil" id="fileInput1"
                        ...
                        <div id="fileDetails1" class="d-none">
                            <div class="file-details">
                                ...
                                <div class="file-actions">
                                    <button type="button" class="btn-file-action retry d-none" id="btnRetry1"
                                        title="Retry">
                                        <i class="bi bi-arrow-clockwise"></i>
                                    </button>
                                    <button type="button" class="btn-file-action delete" id="btnDelete1"
                                        title="Hapus">
                                        <i class="bi bi-x"></i>
                                    </button>
                                </div>
                    ...
                    <div class="upload-section" id="uploadSection2">
                        <div class="upload-section-header">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <button type="button" class="btn-select-file" id="btnSelectFile2">Select
                                    files...</button>
                            </div>
                        </div>
                        <input type="file" class="d-none" name="hasil2" id="fileInput2"
                            accept=".pdf,.jpg,.jpeg,.png">
                        <div id="fileDetails2" class="d-none">
                            <div class="file-details">
                                ...
                                <div class="file-actions">
                                    <button type="button" class="btn-file-action retry d-none" id="btnRetry2"
                                        title="Retry">
                                        <i class="bi bi-arrow-clockwise"></i>
                                    </button>
                                    <button type="button" class="btn-file-action delete" id="btnDelete2"
                                        title="Hapus">
                                        <i class="bi bi-x"></i>
                                    </button>
                                </div>
